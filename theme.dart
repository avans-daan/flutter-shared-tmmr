...
final tmmrThemeData = ThemeData(
  ...
  textTheme: const TextTheme(
    headline1: TextStyle(fontSize: 80.0, fontWeight: FontWeight.bold, color: Colors.white),
    headline2: TextStyle(fontSize: 28.0, fontWeight: FontWeight.bold, color: Colors.white),
    headline3: TextStyle(fontSize: 24.0, fontWeight: FontWeight.bold, color: Colors.white),
    headline6: TextStyle(fontSize: 36.0, fontStyle: FontStyle.normal, color: Colors.white),
